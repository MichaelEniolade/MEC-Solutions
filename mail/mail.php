...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('mail.hotmail.com', 25, 'tls' )
	  ->setUsername('wisdomeniolade@hotmail.com')     
	  ->setPassword('Wisdom_999%')
	  ;
	...
	$message = Swift_Message::newInstance('A message from Form')
	  ...
	  ->setTo(array('wisdomeniolade@hotmail.com' => 'Michael Eniolade'))->setBody($messageText);
//                           ^                    ^
